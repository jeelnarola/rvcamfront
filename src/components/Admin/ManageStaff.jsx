                                               ...
                                               data.map((ele, i) => {
                                                const isChecked = CheckedId.includes(ele._id) || false;
                                                   return <tr>
                                                       ...
                                                       <td className="border border-gray-300 w-[20%] px-2">{ele.subject}</td>
                                                           ...
                                                           <tr>
                                                               <td className='p-1 w-[10%] px-2'>
                                                                   <div className="flex items-center justify-center">
                                                                       <button className="bg-green-600 text-black p-1 px-8 mx-4 rounded-lg flex items-center gap-2" onClick={() => navigate("/admin/AddStaff", { state: { id: ele } })}>
                                                                           <PiNotePencilFill />
                                                                           <p>Edit</p>
                                                                       </button>
