            ...
            <ul class="space-y-2 font-medium xl:p-2 xl:pr-10">
               ...
               <li>
                  ...
                  >
                     ...
                     <span class="flex-1 ms-3 whitespace-nowrap hidden md:block group-hover:block">Send Notify</span>
                  </NavLink>
               </li>
               <li>
                  ...
                  >
                     ...
                     <span class="flex-1 ms-3 whitespace-nowrap hidden md:block group-hover:block">Manage Notify</span>
                  </NavLink>
               </li>
               <li>
